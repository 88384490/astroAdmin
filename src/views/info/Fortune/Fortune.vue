        ...
        <e-row>
          <e-col :span="24">
            <e-tabs v-model="activeName" type="card">
              <e-tab-pane label="事业运势" name="work">
                <e-form-item label="事业运势文案" prop="work">
                  <e-input
                    type="textarea"
              ...
              <e-tab-pane label="爱情运势" name="love">
                <e-form-item label="爱情运势文案" prop="love">
                  <e-input
                    type="textarea"
                    :autosize="{ minRows: 4, maxRows: 4 }"
              ...
              <e-tab-pane label="财运运势" name="money">
                <e-form-item label="财运运势文案" prop="love">
                  <e-input
                    type="textarea"
                    :autosize="{ minRows: 4, maxRows: 4 }"
              ...
              <e-tab-pane label="健康运势" name="health">
                <e-form-item label="健康运势文案" prop="health">
                  <e-input
                    type="textarea"
                    :autosize="{ minRows: 4, maxRows: 4 }"
...
export default class Fortune extends Vue {
  /**
   * 列表相关属性
   * /
   *
  ...
  private columns: Array<any> = [
    ...
    { prop: "work", label: "事业运势", minWidth: 150 },
    { prop: "love", label: "爱情运势", minWidth: 150 },
    { prop: "money", label: "财务运势", minWidth: 150 },
    { prop: "health", label: "健康运势", minWidth: 150 },
  ...
  private async getFortune() {
    let query = await server.query("Fortune");
